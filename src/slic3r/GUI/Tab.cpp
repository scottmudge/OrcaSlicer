...
void TabPrint::build()
{
    ...
    optgroup->append_single_option_line("wall_loops", "strength_settings_walls#wall-loop");
        ...
        optgroup->append_single_option_line("staggered_perimeters", "strength_settings_walls#detect-thin-wall");
        ...
        optgroup->append_single_option_line("min_fill_path_length", "strength_settings_advanced#infill-combination");
